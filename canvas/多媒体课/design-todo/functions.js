...
//图形对象定义
var circle={x:canvas.width/2,y:canvas.height/2,r:canvas.width/4, sAngle:0,eAngle:Math.PI*2,clockWise:false};
var style={color:"orange",fontSize:20,lineWidth:1,
